...
<li><a  class="menu-hover" href="#">Refrigerators</a></li>   		
	 ...
	 <li><a class="menu-hover" href="#">Contact Us</a></li>
				...
				<div class="col-sm-12 col-md-6 col-lg-5">
						<div  id="myCarousel" class="carousel slide" data-ride="carousel">
								  <!-- Wrapper for slides -->
								  <div class="carousel-inner" style="width:70%;margin:auto;" role="listbox">
									...
									<div class="item">
									  <img src="images/slider5.jpg" alt="Flower">
									</div>
									<div class="item">
									  <img src="images/slider6.jpg" alt="Flower">
									</div>
									<div class="item">
									  <img src="images/slider7.jpg" alt="Flower">
									</div>
				...
				<div class="col-sm-12 col-md-6 col-lg-5" style="background:#E2E2E2;"  >
				
				
				<img   style="height:200px;float:left;" src="images/side.jpg"/>
				
			
				
				<img   style="height:200px;width:auto; float:right;" src="images/side2.jpg"/></span>
			...
			<div class="container-fluid" style=" margin:5px;"">	
				...
				<div class="container" >
				<h2 class="display">Detail of Products</h2>
	...
	while($row_product=mysqli_fetch_array($run_product))
	{
		...
		echo"<div style='display:inline-block '> <h3 style='padding-right:20px;color:#980108;text-align:center;'>$pro_title</h3><p>$pro_desc</p><li class='list-item' style='display:inline-block; border:1px solid #00A5D2;padding:10px; margin:20px;'><img style='height:100px;'src='admin_area/product_images/$pro_image' alt='image'><p style='color:#980108';> Rs:$pro_price</p>
